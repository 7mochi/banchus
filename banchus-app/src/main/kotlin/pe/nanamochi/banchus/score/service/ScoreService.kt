...
import pe.nanamochi.banchus.score.broadcast.LeaderboardBroadcaster
import pe.nanamochi.banchus.score.dto.DecryptedScoreData
...
class ScoreService(
    ...
    private val leaderboardBroadcaster: LeaderboardBroadcaster,
    ...
    fun submitScore(
        ...
        if (
            ...
            leaderboardBroadcaster.announceFirstPlace(beatmap, score, user)
        }
    ...
    fun refreshStats(user: User, stats: Stat): Presence? {
        val presence = presenceService.fetchOne(user.id) ?: return null
