...
import pe.nanamochi.banchus.beatmap.mapper.BeatmapsetMapper
import pe.nanamochi.banchus.beatmap.repository.BeatmapsetRepository
import pe.nanamochi.banchus.core.error.BeatmapsetNotFound
...
class BeatmapsetService(
    ...
    fun fetchOneById(id: Int): Result<Beatmapset, BeatmapsetNotFound> =
