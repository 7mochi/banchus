...
public class OsuApiBeatmap {
  ...
  public void setSubmitDate(String date) {
    this.submitDate = parseDate(date);
  }

  @JsonProperty("approved_date")
  @JsonSetter(nulls = Nulls.SKIP)
  public void setApprovedDate(String date) {
    this.approvedDate = parseDate(date);
  }

  @JsonProperty("last_update")
  public void setLastUpdate(String date) {
    this.lastUpdate = parseDate(date);
  }
  ...
  private Instant parseDate(String date) {
    ...
    return LocalDateTime.parse(date, DATE_FORMATTER).toInstant(ZoneOffset.UTC);
  }
}
