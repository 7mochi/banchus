...
public class PacketWriter {
    ...
    public void writePacket(OutputStream stream, Packet packet) throws IOException {
        switch (packet.getPacketType()) {
            ...
            default -> throw new UnsupportedOperationException("Cannot write packet type: " + packet.getPacketType());
        }
    }

    private void writeRawPacket(OutputStream stream, Packets packetType, byte[] data) throws IOException {
