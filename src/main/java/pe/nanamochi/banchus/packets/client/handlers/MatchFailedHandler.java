...
public class MatchFailedHandler extends AbstractPacketHandler<MatchFailedPacket> {
  private static final Logger logger = LoggerFactory.getLogger(MatchFailedHandler.class);
  ...
  public Packets getPacketType() {
    return Packets.OSU_MATCH_FAILED;
  }

  @Override
  public Class<MatchFailedPacket> getPacketClass() {
    return MatchFailedPacket.class;
  }
